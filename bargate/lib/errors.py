...
def upload_file_directory():
	"""Returns a template or redirect to return from the view for when a user tries to upload a file
	over the top of a directory (file upload name is same as existing directory name)"""

	return stderr("Unable to upload file",
		"A directory already exists with the same name as the file you are trying to upload.")


def invalid_item_type():
	"""Returns a template or redirect to return from the view for when an action is
	performed on an invalid item type."""

	return stderr("Invalid item type",
...
def invalid_item_download():
	...
	return stderr("Invalid item type",
		"You tried to download an item other than a file.")


def invalid_item_copy():
	"""Returns a template or redirect to return from the view for when
	a user tries to copy an item other than a file."""

	return stderr("Invalid item type", "You tried to copy an item other than a file.")


def invalid_path():
	"""Returns a template or redirect to return from the view for
	when a user navigates to an invalid path."""
